...
public class ToastAlert_Corner extends JFrame {
    JLabel checkMark,title,background;
    JButton close;
    
    ToastAlert_Corner(String s,String imgs, String cancle){
...
//        background.setBackground(new Color(0, 10, 66));
       ...
       background.add(checkMark);
        ...
        if(imgs.equals("checkToast.png")){ 
            background.setBackground(new Color(4, 112, 0));
...
//        setLocationRelativeTo(null);
    ...
    public static void main(String[ ] arg){
        new ToastAlert_Corner("Message","checkToast.png","delete2.png").setVisible(true);
    }
