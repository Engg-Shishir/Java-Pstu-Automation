...
public class Login extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        alertPanel.add(successLogo, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 10, 50, 50));

        successText.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        successText.setForeground(new java.awt.Color(255, 255, 255));
        alertPanel.add(successText, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 5, 340, 60));
        ...
        alertPanel.add(successClose, new org.netbeans.lib.awtextra.AbsoluteConstraints(410, 15, 40, 40));
